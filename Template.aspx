<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Template.aspx.cs" Inherits="FoodBank.Template" %>
...
<!-- Dashboard Page and Heading -->
            <main class="col-sm-9 ml-sm-auto col-md-10 pt-3" role="main">
              <h1>HEADING HERE</h1> 
                <p class="template">CONTENT HERE</p>
            </main>
          </div>
        </div>
